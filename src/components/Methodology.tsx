...
export const Methodology = () => (
  <details className="mb-5">
    ...
    <div className="details-content copy mt-2">
      <p className="mt-2">
        THE CITY and Gothamist chose a field of 12 candidates based on their
        poll standings, their presence at community forums and other appearances
        that provide a broad record of their positions and their history of
        public service. Most but not all candidates on the ballot are part of
        Meet Your Mayor.
      </p>
      <p className="mt-2">
